...
class PathEnums(Enum):
    ...
    model_path = os.path.join(current_directory, "face_recognition2", "src", "assets", "face_recognition_model.keras")
    label_map_path = os.path.join(current_directory, "face_recognition2", "src", "assets", "label_map.keras")
